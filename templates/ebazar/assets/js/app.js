  ...
  var Init = {
    ...
    cartOperations: function () {
      $('.cart-button').on('click', function (e) {
        ...
        var productName = product.find('.title').text();
      ...
      $('#cart-items').on('click', '.remove-item', function () {
        ...
        Init.removeFromCart(itemName);
      });
    },

    addToCart: function (item) {
      var cart = Init.getCart();
      cart.push(item);
    ...
    loadCart: function () {
      ...
      if (cart.length === 0) {
        cartItemsContainer.append('<li>El carrito está vacío</li>');
      } else {
