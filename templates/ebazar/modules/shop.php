        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/procto-bolsa.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/producto-alebrije.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/producto-llaveros.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/products/producto-blusa.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/producto-sombrero.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/producto-sarape.jpg" alt="">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product-card">
                <div class="showcase-box">
                  <img src="/templates/ebazar/assets/media/products/producto-arbolvida.jpg" alt="">
